...
white_rows = [
    ("인건비",  "사회진행비",              "회",  "6",  "200,000",   "1,200,000", "현장운영(사회자)",     "사회자 교통비 포함"),
    ("제작비",  "행사 사진·영상 촬영 및 편집", "식", "1",  "1,500,000", "1,500,000", "행정·운영지원(영상)", "최종 결과물 1EA"),
    ("인쇄비",  "강연자료집 제작 및 인쇄",  "식",  "1",  "1,000,000", "1,000,000", "제작·인쇄(용역사)",    ""),
    ("제작비",  "SNS 제작비",              "식",  "1",  "400,000",   "400,000",   "홍보(용역사)",         "SNS 게시물 제작"),
    ("제작비",  "포스터 수정비",           "식",  "1",  "300,000",   "300,000",   "홍보(용역사)",         "포스터 수정·편집"),
    ("인쇄비",  "강연장 현수막",           "EA",  "6",  "50,000",    "300,000",   "제작·인쇄(용역사)",    ""),
    ("인건비",  "운영스텝비",              "2인", "6",  "100,000",   "1,200,000", "현장운영",              ""),
    ("운영비",  "행사운영 잡비, 다과 및 회의비", "식", "1", "800,000", "800,000",  "운영지원",              ""),
    ("보고",    "결과보고서 재료 정리 및 저장", "식", "1", "300,000", "300,000",  "행정·운영지원(용역사)", "원자료 정리·아카이빙"),
]
